...
void BoardScene::handleEvent(const std::optional<sf::Event>& event, sf::RenderWindow& window)
{
...
void BoardScene::drawSingleColorStone(const std::array<uint32_t, 19>& stonesMask, sf::RenderWindow& window,
